      ...
      'itemList': [
        {
          ...
          'numberOfItems': 1,
          'description':
              'Fresh, sweet bananas sourced from top-quality farms. Perfect for smoothies, desserts, and on-the-go snacking. A rich source of potassium and natural energy.',
          'price': 0.49,
          'imageUrl':
      ...
      'itemList': [
        {
          ...
          'numberOfItems': 1,
          'description':
              'Bright orange, crunchy carrots that are rich in beta-carotene. Excellent for salads, soups, or snacking raw for a healthy treat.',
          'price': 1.49,
          'imageUrl':
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVgd0I7sZ-qvut2ghl-UhyxKSHkTV7RCR8TA&s',
        },
        {
          'name': 'Tomatoes',
          'quantity': "1kg",
          'numberOfItems': 1,
          'description':
              'Fresh, ripe tomatoes with a juicy texture and tangy flavor. Perfect for sauces, salads, or cooking hearty meals.',
          'price': 0.99,
          'imageUrl':
      ...
      'itemList': [
        {
          ...
          'numberOfItems': 1,
          'description':
              'Rich and creamy fresh milk, sourced from high-quality dairy farms. Perfect for cereals, coffee, or enjoying as is.',
          'price': 1.49,
          'imageUrl':
        ...
        },
        {
          ...
          'numberOfItems': 1,
          'description':
              'Fresh, free-range eggs with a rich yolk. Packed with protein, perfect for breakfast or baking.',
          'price': 2.49,
          'imageUrl':
      ...
      'itemList': [
        {
          ...
          'numberOfItems': 1,
          'description':
              'Soft and fluffy white bread, perfect for sandwiches, toast, or enjoying with butter and jam.',
          'price': 1.49,
    ...
    },
    {
      ...
      'itemList': [
        ...
        },
        {
          ...
          'numberOfItems': 1,
          'description':
              'Rich and chewy cookies loaded with chocolate chunks. A delightful treat to pair with milk or coffee, or enjoy as a sweet snack.',
          'price': 2.49,
          'imageUrl':
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScv8pXNVFXbIXTyDj_E_8zhqelqek9o81dMg&s',
        },
        {
          'name': 'Popcorn',
          'quantity': "300g",
          'numberOfItems': 1,
          'description':
              'Light and airy popcorn, pre-popped and flavored with a buttery touch. The ideal snack for gatherings or a cozy movie night.',
          'price': 1.29,
          'imageUrl':
